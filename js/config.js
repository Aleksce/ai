...
// Прямая привязка к window для доступности во всех файлах (ui.js, game.js, ai.js)
window.CONFIG = {
...
window.LEVELS = [
  ...
  },
  {
    ...
    targetReplies: 30, // Увеличено для прохода всех фаз
    hp: 5
  }
];

// Дублируем глобальные переменные без window для полной совместимости
